...
class CodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create code" do
    assert_difference('Code.count') do
      post codes_url, params: { code: { cle: @code.cle, kits_id: @code.kits_id, validite: @code.validite } }
    end
  ...
  test "should update code" do
    patch code_url(@code), params: { code: { cle: @code.cle, kits_id: @code.kits_id, validite: @code.validite } }
